  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-8 mt-20 justify-center">
        <div className="flex items-center justify-center h-14 w-14 border border-black/10 rounded-full">
          <span className="icon-[logos--react] text-[2rem]"></span>
        </div>

        <div className="flex items-center justify-center h-14 w-14 border border-black/10 rounded-full">
          <span className="icon-[logos--nextjs-icon] text-[2.3rem]"></span>
        </div>
