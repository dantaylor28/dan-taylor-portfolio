  ...
  return (
    <header className="relative z-[999]">
      <motion.div
        ...
        backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[40rem] sm:rounded-full dark:bg-slate-950 dark:bg-opacity-80 dark:border-transparent dark:border-b-cyan-800/50 dark:sm:border-white/20"
